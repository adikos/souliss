/**************************************************************************
    ...
    This node controls two light that can be handled via Android (or any other
    user interface) and pushbuttons.
    
    Run this code on one of the following boards:
      - Arduino UNO/Leonardo with Nordic nRF24L01 or nRF24L01+
